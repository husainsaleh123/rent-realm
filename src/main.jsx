...
import { addPaymentTransaction, amountCollected, amountOutstanding, latestReceipt, paymentStatus, paymentTransactions } from './paymentAmounts';
...
const es = {
  'Overview':'Resumen','Dashboard':'Panel de control','Properties':'Propiedades','Tenants':'Inquilinos','Payments':'Pagos','Settings':'Configuración','Manage your account, appearance, and receipt branding.':'Gestiona tu cuenta, apariencia y marca de recibos.','Appearance':'Apariencia','Choose how Rent Realm looks on this device.':'Elige cómo se ve Rent Realm en este dispositivo.','Bright and clean':'Claro y luminoso','Easy on the eyes':'Cómodo para la vista','Log out':'Cerrar sesión','Sign out of your Rent Realm account on this device.':'Cierra sesión de tu cuenta de Rent Realm en este dispositivo.','Dark mode':'Modo oscuro','Light mode':'Modo claro',
  'Username':'Nombre de usuario','Email address':'Correo electrónico','Email address (optional)':'Correo electrónico (opcional)','Password':'Contraseña','Confirm password':'Confirmar contraseña','Create your account':'Crea tu cuenta','Create account':'Crear cuenta','Log in':'Iniciar sesión','Welcome back':'Bienvenido de nuevo','SECURE ACCESS':'ACCESO SEGURO',
  'Use your email and password to access your portfolio.':'Usa tu correo y contraseña para acceder a tu cartera.','Sign up with your display name, email, phone number, and password.':'Regístrate con tu nombre, correo, teléfono y contraseña.','Display name':'Nombre visible','Mobile number':'Número de móvil','Show password':'Mostrar contraseña','Hide password':'Ocultar contraseña','Back to home':'Volver al inicio','Account access':'Acceso a la cuenta',
  'Email or password is incorrect.':'El correo o la contraseña son incorrectos.','An account with this email already exists.':'Ya existe una cuenta con este correo.','Enter a valid email address.':'Introduce un correo electrónico válido.','Enter a valid phone number with country code.':'Introduce un teléfono válido con código de país.','Display name must be at least 2 characters.':'El nombre debe tener al menos 2 caracteres.','Password must be at least 6 characters.':'La contraseña debe tener al menos 6 caracteres.','Passwords do not match.':'Las contraseñas no coinciden.','Already have an account? Log in':'¿Ya tienes cuenta? Inicia sesión','New here? Create an account':'¿Eres nuevo? Crea una cuenta',
  'Good evening':'Buenas tardes','Here’s what’s happening with your properties.':'Esto es lo que ocurre con tus propiedades.','Manage your rental portfolio.':'Gestiona tu cartera de alquileres.','Everyone who calls your properties home.':'Todas las personas que viven en tus propiedades.','Track monthly rent collection.':'Controla el cobro mensual del alquiler.',
  'Add property':'Añadir propiedad','Add a property':'Añadir una propiedad','Add tenant':'Añadir inquilino','Active tenants':'Inquilinos activos','Collected this month':'Cobrado este mes','Collection rate':'Tasa de cobro','Across all properties':'En todas las propiedades','total units':'unidades totales','payments':'pagos','outstanding':'pendiente',
  'MONTHLY PROGRESS':'PROGRESO MENSUAL','Rent collection':'Cobro de alquileres','View all':'Ver todo','Total expected':'Total previsto','Collected':'Cobrado','Outstanding':'Pendiente','collected':'cobrado','NEEDS ATTENTION':'REQUIERE ATENCIÓN','Outstanding rent':'Alquiler pendiente','All caught up!':'¡Todo al día!','Everyone has paid for':'Todos han pagado','PORTFOLIO':'CARTERA','Your properties':'Tus propiedades','PAYMENTS':'PAGOS','Recent payments':'Pagos recientes','No payments yet':'Aún no hay pagos','Recorded payments will appear here.':'Los pagos registrados aparecerán aquí.','Manage properties':'Gestionar propiedades','tenants':'inquilinos','units':'unidades',
  'YOUR PORTFOLIO':'TU CARTERA','All properties':'Todas las propiedades','properties':'propiedades','Units':'Unidades','Monthly rent':'Alquiler mensual','Search tenants or units':'Buscar inquilinos o unidades','active tenants':'inquilinos activos','Tenant':'Inquilino','Property':'Propiedad','Unit':'Unidad','Paid':'Pagado','Unpaid':'No pagado','Partially paid':'Pago parcial','Expected':'Previsto','Viewing month':'Mes mostrado','PAYMENT REGISTER':'REGISTRO DE PAGOS','Record payment':'Registrar pago','Record another payment':'Registrar otro pago','Mark as paid':'Marcar como pagado',
  'Edit tenant':'Editar inquilino','Add a new tenant':'Añadir un inquilino','Update their personal, property, or rent details.':'Actualiza sus datos personales, de propiedad o alquiler.','Enter their lease and rent details.':'Introduce los datos del contrato y alquiler.','Full name':'Nombre completo','Select property':'Seleccionar propiedad','Monthly rent (BHD)':'Alquiler mensual (BHD)','Move-in date':'Fecha de entrada','Phone number':'Teléfono','Photo (optional)':'Foto (opcional)','Upload photo':'Subir foto','Change photo':'Cambiar foto','Cancel':'Cancelar','Save changes':'Guardar cambios',
  'Edit property':'Editar propiedad','Create a new property in your portfolio.':'Crea una nueva propiedad en tu cartera.','Update the property information below.':'Actualiza la información de la propiedad.','Property name':'Nombre de la propiedad','Location or address':'Ubicación o dirección','Number of units':'Número de unidades','Empty flats':'Pisos vacíos','Empty flats cannot exceed the total number of units.':'Los pisos vacíos no pueden superar el total de unidades.','Property photo (optional)':'Foto de la propiedad (opcional)','Remove':'Eliminar',
  'Amount paid':'Importe pagado','Previously collected':'Cobrado anteriormente','Remaining balance':'Saldo restante','Payment date':'Fecha de pago','Payment method':'Método de pago','Cash':'Efectivo','Debit Card':'Tarjeta de débito','Credit Card':'Tarjeta de crédito','Cheque':'Cheque','Save payment':'Guardar pago','Receipt':'Recibo','View receipt':'Ver recibo','Download receipt':'Descargar recibo','Download PDF':'Descargar PDF','Receipt details':'Detalles del recibo','Receipt voucher':'Comprobante de pago',
  'Sort by':'Ordenar por','By Month':'Por mes','By Tenant':'Por inquilino','By Unit':'Por unidad','Ascending':'Ascendente','Descending':'Descendente','All recorded months':'Todos los meses registrados','Selected month':'Mes seleccionado','Month':'Mes','No matching payments.':'No hay pagos coincidentes.','Outstanding amounts':'Importes pendientes','Amount outstanding':'Importe pendiente','Total outstanding':'Total pendiente','Status':'Estado','Property & unit':'Propiedad y unidad','Rent due':'Alquiler adeudado','of':'de',
  'Language':'Idioma','English':'Inglés','Arabic':'Árabe','Spanish':'Español','Property Manager':'Administrador de propiedades','Property Owner':'Propietario','Owner account':'Cuenta del propietario','Account settings':'Configuración de la cuenta','Receipt branding':'Marca del recibo','Customize the business identity shown on customer receipts.':'Personaliza la identidad comercial que aparece en los recibos.','Property firm name':'Nombre de la empresa inmobiliaria','Firm logo (optional)':'Logotipo de la empresa (opcional)','Firm logo':'Logotipo de la empresa','Upload logo':'Subir logotipo','Change logo':'Cambiar logotipo','Shown in the receipt header. PNG or JPG works best.':'Se muestra en el encabezado del recibo. PNG o JPG funciona mejor.','Change password':'Cambiar contraseña','New password':'Nueva contraseña','Confirm new password':'Confirmar nueva contraseña','Password changed successfully.':'Contraseña actualizada correctamente.',
  'Delete property':'Eliminar propiedad','Delete tenant':'Eliminar inquilino','Delete this property and all of its tenants?':'¿Eliminar esta propiedad y todos sus inquilinos?','Remove this tenant?':'¿Eliminar este inquilino?','No properties yet':'Aún no hay propiedades','No tenants yet':'Aún no hay inquilinos','Rent contract':'Contrato de alquiler','Upload contract':'Subir contrato','Replace contract':'Reemplazar contrato','View contract':'Ver contrato','Open PDF':'Abrir PDF',
  'Every property.':'Cada propiedad.','Every payment.':'Cada pago.','Perfectly clear.':'Todo muy claro.','RENT MANAGEMENT, SIMPLIFIED':'GESTIÓN DE ALQUILERES SIMPLIFICADA','A calm, organized space to manage your tenants and stay on top of every month.':'Un espacio claro y organizado para gestionar tus inquilinos y tener cada mes bajo control.'
};
const translations = { ar, es };
const tx = (lang, text) => translations[lang]?.[text] || text;
...
function LanguageSelect({ lang, setLang, className='' }) {
  return <label className={`language-select ${className}`}><Globe2 size={16}/><span className="sr-only">{tx(lang,'Language')}</span><select aria-label={tx(lang,'Language')} value={lang} onChange={event=>setLang(event.target.value)}>{languageOptions.map(option=><option key={option.value} value={option.value}>{option.label}</option>)}</select><ChevronDown size={14}/></label>;
}
...
function ReceiptLogoField({ value, onChange }) {
 return <label className="image-field receipt-logo-field"><span>{t("Firm logo (optional)")}</span><div>{value?<img src={value} alt={t("Firm logo")}/>:<span className="receipt-logo-placeholder"><Building2 size={24}/></span>}<label className="upload-btn"><Camera size={16}/><span>{t(value?"Change logo":"Upload logo")}</span><input type="file" accept="image/png,image/jpeg,image/webp" onChange={async e=>{if(e.target.files[0])onChange(await resizeImage(e.target.files[0],500))}}/></label>{value&&<button type="button" className="remove-photo" onClick={()=>onChange("")}>{t("Remove")}</button>}</div><small>{t("Shown in the receipt header. PNG or JPG works best.")}</small></label>;
}
function PersonAvatar({ tenant }) { return <img className="avatar avatar-photo" src={tenant.image||'/images/default-tenant.webp'} alt=""/> }
const emptyData = () => ({ properties: [], tenants: [], payments: {}, branding: { firmName: '', logo: '' } });
const hasPortfolioData = data => Boolean(data?.properties?.length || data?.tenants?.length || Object.keys(data?.payments || {}).length || data?.branding?.firmName || data?.branding?.logo);

const activeLocale = () => activeLanguage==='ar'?'ar-BH-u-nu-latn':activeLanguage==='es'?'es-ES':'en-US';
  ...
  const t=s=>tx(lang,s); return <main className="auth-page">
    ...
    <section className="auth-form-wrap">
      <form className="auth-form" onSubmit={submit}>
        ...
        <LanguageSelect lang={lang} setLang={setLang} className="lang-auth"/>
...
function LandingPage({ onAccess, lang, setLang }) {
  ...
  const copy = lang==='ar' ? {
    ...
    nav:['Funciones','Cómo funciona','Por qué Rent Realm'], login:'Iniciar sesión', start:'Empezar',
    eyebrow:'DEJA DE PERSEGUIR ALQUILERES. EMPIEZA A GESTIONARLOS.',
    title:<>Todas tus propiedades.<br/><em>En un solo lugar.</em></>,
    body:'Rent Realm convierte el caos de la gestión inmobiliaria en un sistema claro: pagos, contratos, inquilinos y recibos, todo bajo control.',
    cta:'Crea tu cuenta', secondary:'Descubre cómo funciona', note:'Configúralo en minutos • No necesitas tarjeta', trusted:'Creado para propietarios y administradores',
    benefits:[['Sabe quién pagó al instante','Controla cada mes los alquileres cobrados y pendientes sin hojas de cálculo dispersas.'],['Mantén todo organizado','Propiedades, inquilinos, contratos e historial de pagos permanecen juntos.'],['Convierte pagos en comprobantes','Registra un pago y crea en segundos un recibo PDF descargable y compartible.'],['Un perfil para cada inquilino','Guarda contactos, unidades, alquiler y fecha de entrada en un perfil completo.'],['No pierdas de vista ningún saldo','Detecta importes pendientes y pagos parciales que requieren atención.'],['Trabaja a tu manera','Cambia entre español, inglés y árabe, y entre modo claro y oscuro.']],
    howTitle:'De una nueva propiedad a cobros claros', howBody:'Un flujo sencillo que agiliza las tareas administrativas.',
    steps:[['01','Añade tus propiedades','Registra unidades y direcciones y organiza tu cartera.'],['02','Conecta a tus inquilinos','Mantén cerca los contactos, alquileres y contratos.'],['03','Controla cada pago','Registra cobros, consulta saldos y emite recibos.']],
    close:'Menos administración. Más tiempo para ti.', closeBody:'Empieza hoy a organizar tu cartera y simplifica el seguimiento de los alquileres.', dashboard:'Resumen de la cartera', collected:'Cobrado este mes', outstanding:'Pendiente', tenants:'Inquilinos activos', ontrack:'Tasa de cobro', attention:'Requiere atención', paid:'Pagado', due:'Pendiente',
    previewKicker:'¿AÚN NO TE DECIDES?', previewTitle:'Conoce Rent Realm a tu manera', previewBody:'Mira un recorrido rápido o reserva una conversación virtual con el propietario.', demoTitle:'Ver demostración', demoBody:'Un recorrido breve por propiedades, inquilinos, pagos y recibos.', demoSoon:'Demostración próximamente', demoSoonBody:'Estamos preparando un recorrido claro y conciso. Pronto estará disponible aquí.', watchDemo:'Ver demostración', comingSoon:'Próximamente', bookTitle:'Reservar reunión virtual', bookBody:'Elige la hora y la plataforma que prefieras y habla directamente con el propietario.', bookMeeting:'Elegir una hora', bookModalBody:'Elige tu horario preferido. El propietario lo confirmará y enviará el enlace.', name:'Nombre completo', email:'Correo electrónico', date:'Fecha preferida', time:'Hora preferida', platform:'Plataforma de reunión', notes:'Notas (opcional)', notesPlaceholder:'¿De qué te gustaría hablar?', requestMeeting:'Solicitar reunión', cancel:'Cancelar', emailOpened:'Tu aplicación de correo se ha abierto para enviar la solicitud.', gotIt:'Entendido'
  } : {
  ...
  return <main className="landing-page">
    <nav className="landing-nav"><button className="landing-logo" onClick={()=>scrollTo('top')}><span><Building2 size={21}/></span>Rent Realm</button><div className="landing-links"><button onClick={()=>scrollTo('features')}>{copy.nav[0]}</button><button onClick={()=>scrollTo('how')}>{copy.nav[1]}</button><button onClick={()=>scrollTo('why')}>{copy.nav[2]}</button></div><div className="landing-actions"><LanguageSelect lang={lang} setLang={setLang} className="landing-language"/><button className="landing-login" onClick={()=>onAccess('login')}>{copy.login}</button><button className="landing-primary small" onClick={()=>onAccess('register')}>{copy.start}<ArrowRight size={16}/></button></div></nav>
...
function Sidebar({ page, setPage, open, setOpen, lang, setLang, user }) {
  const links = [
    ['dashboard', LayoutDashboard, 'Dashboard'], ['properties', Building2, 'Properties'],
  ...
  const t=s=>tx(lang,s); return <><aside className={`sidebar ${open?'open':''}`}>
    ...
    <div className="side-bottom"><button className={page==='settings'?'active':''} onClick={()=>{setPage('settings');setOpen(false)}}><Settings size={19}/> {t('Settings')}</button><div className="side-card"><div className="avatar">{initials(user?.username||'RM')}</div><div><strong>{user?.username||t('Property Manager')}</strong><span>{t(user?.role==='tenant'?'Tenant':'Property Owner')}</span><span>{user?.email||t('Owner account')}</span></div></div><LanguageSelect lang={lang} setLang={setLang} className="sidebar-language"/></div>
...
function Header({ page, setMenu, onAdd, lang, username }) {
  ...
  const titles = { dashboard:['Good evening','Here’s what’s happening with your properties.'], properties:['Properties','Manage your rental portfolio.'], tenants:['Tenants','Everyone who calls your properties home.'], payments:['Payments','Track monthly rent collection.'], settings:['Settings','Manage your account, appearance, and receipt branding.'] };
  const hour=now.getHours()%12||12;
  const clock=[hour,now.getMinutes(),now.getSeconds()].map(value=>String(value).padStart(2,'0')).join(':');
  const period=now.getHours()>=12?'PM':'AM';
  const locale=lang==='ar'?'ar-BH-u-nu-latn':lang==='es'?'es-ES':'en-US';
  const t=s=>tx(lang,s); return <header className="topbar"><button className="menu-btn" onClick={()=>setMenu(true)}><Menu/></button><div><span className="date">{now.toLocaleDateString(locale,{weekday:'long',month:'long',day:'numeric'})}<i>·</i><time dateTime={now.toISOString()}>{clock} {period}</time></span><h1>{t(titles[page][0])}{page==='dashboard'&&username?`, ${username}`:''}</h1><p>{t(titles[page][1])}</p></div>{page!=='settings'&&<button className="primary" onClick={onAdd}><Plus size={18}/><span>{t(page==='properties'?'Add property':'Add tenant')}</span></button>}</header>;
}
...
function Dashboard({ data, month, setMonth, setPage, togglePaid, lang }) {
  ...
  const recentPayments = Object.entries(data.payments || {}).flatMap(([paymentMonth,tenantPayments])=>Object.entries(tenantPayments || {}).flatMap(([tenantId,payment])=>paymentTransactions(payment).map(transaction=>({transaction,paymentMonth,tenant:data.tenants.find(item=>item.id===tenantId)})))).filter(item=>item.tenant&&item.transaction?.amount).sort((a,b)=>(b.transaction.date||b.paymentMonth).localeCompare(a.transaction.date||a.paymentMonth)).slice(0,5);
  return <>
    ...
    <section className="dashboard-recent-grid">
      <div className="panel recent"><div className="panel-head"><div><span className="eyebrow">{t("PORTFOLIO")}</span><h2>{t("Your properties")}</h2></div><button className="text-btn" onClick={()=>setPage("properties")}>{t("Manage properties")} <ChevronRight size={16}/></button></div><div className="property-preview">{data.properties.slice(0,2).map(p=>{const ts=data.tenants.filter(tenant=>tenant.propertyId===p.id);return <article key={p.id}><div className="property-art has-photo" style={{backgroundImage:`linear-gradient(#173e3038,#173e3038),url(${p.image||DEFAULT_PROPERTY_IMAGE})`}}><Building2/></div><div><strong>{p.name}</strong><span>{p.address}</span><small><Users size={14}/>{ts.length} {t("tenants")} <i/> {p.units} {t("units")}</small></div></article>})}</div></div>
      <div className="panel recent recent-payments"><div className="panel-head"><div><span className="eyebrow">{t("PAYMENTS")}</span><h2>{t("Recent payments")}</h2></div><button className="text-btn" onClick={()=>setPage("payments")}>{t("View all")} <ChevronRight size={16}/></button></div>{recentPayments.length?<div className="recent-payment-list">{recentPayments.map(({transaction,paymentMonth,tenant})=><div className="recent-payment" key={transaction.id||paymentMonth+tenant.id}><PersonAvatar tenant={tenant}/><div><strong>{tenant.name}</strong><span>{transaction.date?transaction.date.split("-").reverse().join("/"):monthLabel(paymentMonth)} · {t(transaction.method||"Cash")}</span></div><b>{money(Number(transaction.amount))}</b></div>)}</div>:<div className="empty compact"><Wallet/><b>{t("No payments yet")}</b><span>{t("Recorded payments will appear here.")}</span></div>}</div>
    </section>
  </>;
}

function Properties({ data, onDelete, onEdit }) { return <section className="content-panel"><div className="section-title"><div><span className="eyebrow">{t('YOUR PORTFOLIO')}</span><h2>{t('All properties')}</h2></div><span>{data.properties.length} {t('properties')}</span></div><div className="property-grid">{data.properties.map(p=>{const ts=data.tenants.filter(tenant=>tenant.propertyId===p.id);const income=ts.reduce((sum,tenant)=>sum+tenant.rent,0);return <article className="property-card" key={p.id}><div className="property-hero has-photo" style={{backgroundImage:`linear-gradient(#173e3028,#173e3028),url(${p.image||DEFAULT_PROPERTY_IMAGE})`}}><div className="property-actions"><button onClick={()=>onEdit(p)} title={t('Edit property')}><Pencil size={17}/></button><button onClick={()=>onDelete(p.id)} title={t('Delete property')}><Trash2 size={17}/></button></div></div><div className="property-body"><h3>{p.name}</h3><p>{p.address}</p><div className="property-metrics"><div><span>{t('Tenants')}</span><b>{ts.length}</b></div><div><span>{t('Units')}</span><b>{p.units}</b></div><div><span>{t('Empty flats')}</span><b>{Math.max(0,Number(p.units)-ts.length)}</b></div><div><span>{t('Monthly rent')}</span><b>{money(income)}</b></div></div></div></article>})}</div></section> }
...
function SettingsPage({user,branding={},theme,setTheme,onSave,onChangePassword,onLogout}) {
 ...
 return <section className="settings-page"><div className="settings-grid"><form className="settings-card settings-profile-form" onSubmit={async e=>{e.preventDefault();setSaving(true);setError('');try{const error=await onSave({name:name.trim(),phone:phone.trim(),branding:{firmName:firmName.trim(),logo:firmLogo}});if(error)setError(error)}catch(error){setError(error.message)}finally{setSaving(false)}}}><label>{t('Display name')}<input required minLength={2} value={name} onChange={e=>setName(e.target.value)}/></label><label>{t('Email address')}<input type="email" readOnly value={user.email||''} autoComplete="email"/></label><label>{t('Mobile number (optional)')}<input type="tel" autoComplete="tel" value={phone} onChange={e=>setPhone(e.target.value)} placeholder="+973 0000 0000"/></label><div className="appearance-settings"><h3>{t('Appearance')}</h3><p>{t('Choose how Rent Realm looks on this device.')}</p><div className="theme-options"><button type="button" className={theme==='light'?'active':''} onClick={()=>setTheme('light')}><Sun size={20}/><span><strong>{t('Light mode')}</strong><small>{t('Bright and clean')}</small></span><Check size={17}/></button><button type="button" className={theme==='dark'?'active':''} onClick={()=>setTheme('dark')}><Moon size={20}/><span><strong>{t('Dark mode')}</strong><small>{t('Easy on the eyes')}</small></span><Check size={17}/></button></div></div><div className="receipt-branding-settings"><h3>{t('Receipt branding')}</h3><p>{t('Customize the business identity shown on customer receipts.')}</p><label>{t('Property firm name')}<input value={firmName} onChange={e=>setFirmName(e.target.value)} placeholder="e.g. Horizon Property Management"/></label><ReceiptLogoField value={firmLogo} onChange={setFirmLogo}/></div>{error&&<p className="form-error" role="alert">{error}</p>}<div className="modal-actions"><button className="primary" disabled={saving}>{t('Save changes')}</button></div></form><div className="settings-side-column"><form className="settings-card account-password-form" onSubmit={changePassword}><h3>{t('Change password')}</h3><label>{t('New password')}<input required minLength={6} type={showPassword?'text':'password'} autoComplete="new-password" value={password} onChange={e=>{setPassword(e.target.value);setPasswordNotice('')}}/></label><label>{t('Confirm new password')}<input required minLength={6} type={showPassword?'text':'password'} autoComplete="new-password" value={confirmation} onChange={e=>setConfirmation(e.target.value)}/></label><button type="button" className="text-btn" aria-pressed={showPassword} onClick={()=>setShowPassword(!showPassword)}>{t(showPassword?'Hide password':'Show password')}</button>{passwordError&&<p className="form-error" role="alert">{t(passwordError)}</p>}{passwordNotice&&<p className="form-success" role="status"><Check size={16}/>{t(passwordNotice)}</p>}<div className="modal-actions"><button className="primary" disabled={saving}>{t('Change password')}</button></div></form><section className="settings-card logout-settings"><div><h3>{t('Log out')}</h3><p>{t('Sign out of your Rent Realm account on this device.')}</p></div><button type="button" className="logout-btn" onClick={onLogout}><LogOut size={18}/>{t('Log out')}</button></section></div></div></section>;
}
...
function AddProperty({ onClose,onSave,initial,lang }) { const [f,setF]=useState(initial?{...initial}:{name:"",address:"",units:"",image:""});const t=s=>tx(lang,s);const submit=e=>{e.preventDefault();onSave({...f,units:Number(f.units)})};return <Modal title={t(initial?"Edit property":"Add a property")} subtitle={t(initial?"Update the property information below.":"Create a new property in your portfolio.")} onClose={onClose}><form className="modal-form" onSubmit={submit}><ImageField property value={f.image} onChange={image=>setF({...f,image})} lang={lang}/><label>{t("Property name")}<input required autoFocus value={f.name} onChange={e=>setF({...f,name:e.target.value})} placeholder="e.g. Bay View Residence"/></label><label>{t("Location or address")}<input required value={f.address} onChange={e=>setF({...f,address:e.target.value})} placeholder="e.g. Amwaj Islands"/></label><label>{t("Number of units")}<input required min="1" step="1" type="number" value={f.units} onChange={e=>setF({...f,units:e.target.value})} placeholder="10"/></label><div className="modal-actions"><button type="button" className="secondary" onClick={onClose}>{t("Cancel")}</button><button className="primary">{initial?<Pencil size={17}/>:<Building2 size={17}/>} {t(initial?"Save changes":"Add property")}</button></div></form></Modal> }
...
function App({ authMode='login', onBack }) {
 ...
 const onReceipt=(tenant,paymentMonth=month)=>{const receipt=latestReceipt(data.payments[paymentMonth]?.[tenant.id]);if(receipt?.number)setModal({type:'receipt',receipt:{...receipt,branding:data.branding||receipt.branding||{},propertyAddress:receipt.propertyAddress??data.properties.find(property=>property.id===tenant.propertyId)?.address??''}});else setModal({type:'payment',tenant,month:paymentMonth,legacy:true,collected:0})};
 ...
 return <div className="app"><Sidebar page={page} setPage={setPage} open={menu} setOpen={setMenu} lang={lang} setLang={setLang} user={currentUser}/><main className="main"><Header page={page} setMenu={setMenu} onAdd={add} lang={lang} username={currentUser.username}/>{syncError&&<div className="sync-error" role="alert"><AlertCircle size={17}/>{t(syncError)}</div>}<div className="content">{page==='dashboard'&&<Dashboard lang={lang} data={data} month={month} setMonth={setMonth} setPage={setPage} togglePaid={togglePaid}/>} {page==='properties'&&<Properties data={data} onEdit={p=>setModal({type:'property',item:p})} onDelete={id=>{if(confirm(tx(lang,'Delete this property and all of its tenants?')))setData(d=>({...d,properties:d.properties.filter(p=>p.id!==id),tenants:d.tenants.filter(t=>t.propertyId!==id)}))}}/>} {page==='tenants'&&<Tenants data={data} month={month} togglePaid={togglePaid} onViewContract={viewContract} onEdit={tenant=>setModal({type:'tenant',item:tenant})} onDelete={id=>{if(confirm(tx(lang,'Remove this tenant?')))setData(d=>({...d,tenants:d.tenants.filter(tenant=>tenant.id!==id)}))}}/>} {page==='payments'&&<Payments data={data} month={month} setMonth={setMonth} togglePaid={togglePaid} onReceipt={onReceipt}/>} {page==='settings'&&<SettingsPage user={currentUser} onLogout={()=>supabase.auth.signOut()} branding={data.branding} theme={theme} setTheme={setTheme} onChangePassword={async password=>{const {data:updated,error}=await supabase.auth.updateUser({password});if(error)return error.message;setSession(previous=>({...previous,user:updated.user}))}} onSave={async fields=>{const {data:updated,error}=await supabase.auth.updateUser({data:{full_name:fields.name,username:fields.name,phone:fields.phone}});if(error)return error.message;setData(previous=>({...previous,branding:fields.branding}));setSession(previous=>({...previous,user:updated.user}))}}/>}</div></main>{modal?.type==='receipt'&&<ReceiptPreview receipt={modal.receipt} onClose={()=>setModal(null)}/>} {modal?.type==='payment'&&<RecordPayment key={modal.tenant.id+modal.month} tenant={modal.tenant} legacy={modal.legacy} onClose={()=>setModal(null)} onSave={savePayment}/>} {(modal==='tenant'||modal?.type==='tenant')&&<AddTenant lang={lang} properties={data.properties} initial={modal?.item} onClose={()=>setModal(null)} onSave={saveTenant}/>} {(modal==='property'||modal?.type==='property')&&<AddProperty lang={lang} initial={modal?.item} onClose={()=>setModal(null)} onSave={saveProperty}/>}</div>;
}
