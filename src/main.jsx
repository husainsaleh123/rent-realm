...
function Sidebar({ page, setPage, onLogout, open, setOpen, lang, setLang, user }) {
  const links = [
...
function SettingsPage({user,branding={},theme,setTheme,onSave,onChangePassword}) {
