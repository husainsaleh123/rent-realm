...
const es = {
  'Overview':'Resumen','Properties':'Propiedades','Tenants':'Inquilinos','Payments':'Pagos','Settings':'Configuración','Log out':'Cerrar sesión','Dark mode':'Modo oscuro','Light mode':'Modo claro',
...
function AccountSettings({user,branding={},onClose,onSave,onChangePassword}) {
